...
public class AjouterConferenceController implements Initializable {
    ...
    @FXML private TextArea intervenantsArea;
    ...
    private void handleAjouter() {
        try {
            ...
            String intervenant = intervenantsArea.getText().trim();
            ...
            Concert concert = new Concert(
                    ...
                    nom, dateTime, lieu, capacite, theme, intervenant
            );
    ...
    private boolean validerChamps() {
        ...
        if (themeField.getText().trim().isEmpty()) {
            showAlert(Alert.AlertType.WARNING, "Validation", "Le thème est obligatoire.");
            return false;
        }

        if (intervenantsArea.getText().trim().isEmpty()) {
            showAlert(Alert.AlertType.WARNING, "Validation", "Les intervenants  sonts obligatoires.");
            return false;
        }
